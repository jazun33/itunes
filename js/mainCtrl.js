        ...
        columnDefs: [
            {
                ...
                width: '40px',
                cellTemplate:
'<div class="ngCellText" ng-class="col.colIndex()"><a href="{{row.getProperty(col.field)}}"><img src="http://www.icty.org/x/image/Miscellaneous/play_icon30x30.png"></a></div>'
            },
            {
                field: 'Artist',
                displayName: 'Artist'
                ...
                displayName: 'Collection'},
            {
                ...
                width: '110px',
                cellTemplate:
'<div class="ngCellText" ng-class="col.colIndex()"><img src="{{row.getProperty(col.field)}}"></div>'
            },
            {
                field: 'Type',
                displayName: 'Type'
...
//Now write a function that will call the method on the itunesService that is responsible for
//getting the data from iTunes, whenever the user clicks the submit button
//*remember, that method should be expecting an artist name. The artist name is coming from the
//input box on index.html, head over there and check if that input box is tied to any specific
//model we could use.
...
//Once you have that final data array, you simply need to put it on the scope (or more
//specifically on the scope as songData). Once you do this ($scope.songData = myFinalArray)
